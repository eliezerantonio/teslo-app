...
class Stock extends FormzInput<int, StockError> {
  ...
  String? get errorMessage {
    ...
    if (displayError == StockError.empty) return 'O campo é obrigatório';

    if (displayError == StockError.value) return 'Deve ser zero ou maior';

    if (displayError == StockError.format) return 'Formato não esperado';
